...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="COUNTER" URI="http://resources/4.1.10/app/COUNTER/0" description="Counts the occurrences of external events using one timer slice of CCU4 or CCU8 " mode="NOTSHARABLE" version="4.1.10" minDaveVersion="4.3.2" instanceLabel="COUNTER_RotationTime" appLabel="" containingProxySignal="true">
